...
const itemsFromDB = [
  {
    ...
    time: {
      ...
      end: GSTC.api.date('2020-01-01 00:00:05').endOf('second').valueOf(),
    },
  },
  {
    id: '2',
    ...
    rowId: '2',
    time: {
      start: GSTC.api.date('2020-01-01 00:01:00').valueOf(),
      end: GSTC.api.date('2020-01-01 00:01:10').endOf('second').valueOf(),
    },
  },
];
...
const seconds = [
  {
    ...
    format({ timeStart, vido }) {
      return vido.html`<div style="text-align:center;">${timeStart.format('HH:mm:ss')}</div>`; // full list of formats: https://day.js.org/docs/en/display/format
    },
  },
];
...
const config = {
  ...
  chart: {
    ...
    time: {
      zoom: 4,
      period: 'second',
      from: GSTC.api.date('2020-01-01T00:00:00').startOf('hour').valueOf(),
      to: GSTC.api.date('2020-01-01T00:00:0').endOf('hour').valueOf(),
    },
  },
};
